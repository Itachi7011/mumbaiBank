                            ...
                            return (<div className="card-body jobSearchCard-body" key={email}>
                                ...
                                <div className="mb-5" style={{
                                    ...
                                    <button className="btn btn-primary btn-lg" onClick={() => {
                                        navigate("/ViewSavingAccountOngoingLoans",
                                            {
                                                state: {
                                                    id: _id,
                                                    name: name,
                                ...
                                <div className="mb-5" style={{
                                    ...
                                    <button type="submit" className="btn btn-primary btn-lg" onClick={() => {
                                        navigate("/SavingAccountApplyNewLoanForm",
                                            {
                                                state: {
                                                    id: _id,
                                                    name: name,
...
<div className="mb-5" style={{
                                    ...
                                    <button className="btn btn-primary btn-lg" onClick={() => {
                                        navigate("/CustomerCurrentLoans")
                                    }} style={{ float: "left" }}>

                                      Click  For Current Account Loans </button>

                                </div>
        <h2 className="searchtext1 main-body main-header" >Saving Account Loans List : </h2>
...
export default CustomerSavingLoans;