...
const GovtJobCompensation = () => {
        ...
        <>
          <div>
            ...
            <h1 style={{backgroundColor:"green", color:"white", margin:"1rem 5rem", padding:"1rem"}}>
                Provide Compensation to All of The Govt. Job Employees' Accounts
            </h1>
            <br/>
  ...
  <br/>
            <br/>
            <div className="main-body">
                <form action="/govtJobCompensation" method="POST">
...
export default GovtJobCompensation;
