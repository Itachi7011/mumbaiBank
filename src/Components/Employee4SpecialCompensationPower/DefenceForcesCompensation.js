...
const DefenceForcesCompensation = () => {
    let name,value;
        ...
        <>
          <div>
            ...
            <h1 style={{backgroundColor:"green", color:"white", margin:"1rem 5rem", padding:"1rem"}}>
                Provide Compensation to All of The Defence Forces' Accounts
            </h1>
            <br/>
  ...
  <br/>
            <br/>
            <div className="main-body">
                <form action="/defenceForcesCompensation" method="POST">
...
export default DefenceForcesCompensation;
