...
const PensionHoldersCompensation = () => {
    let name,value;
        ...
        <>
          <div>
            ...
            <h1 style={{backgroundColor:"green", color:"white", margin:"1rem 5rem", padding:"1rem"}}>
                Provide Compensation to All of The Pension Holders' Accounts
            </h1>
            <br/>
  ...
  <br/>
            <br/>
            <div className="main-body">
                <form action="/pensionHoldersCompensation" method="POST">
...
export default PensionHoldersCompensation;
