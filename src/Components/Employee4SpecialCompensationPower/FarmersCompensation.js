...
const FarmersCompensation = () => {
        ...
        <>
          <div>
            ...
            <h1 style={{backgroundColor:"green", color:"white", margin:"1rem 5rem", padding:"1rem"}}>
                Provide Compensation to All of The Farmers' Accounts
            </h1>
            <br/>
  ...
  <br/>
            <br/>
            <div className="main-body">
                <form action="/farmersCompensation" method="POST">
...
export default FarmersCompensation;
