...
const ViewCurrentAccountOngoingLoans = () => {
    ...
    useEffect(() => {
        ...
        axios.get('/currentAccountFDList').then((response) => {
                    ...
                    <div className="main-body">
...

                        {
                            Data.post.filter((data) => {
                                ...
                                .map(({ name, email, accountNumber, fatherName, fixedDepositStartDate, fixedDepositEndDate, interestPerYearOnFixedDeposit, totalInterestOnfixedDeposit, totalAmountAfterAddingInterest, fixedDepositPercentage,  fixedDepositTotalTimeInYears, fixedDepositAmount}) => {
