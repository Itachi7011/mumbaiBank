...
const CurrentAccountNewFixedDepositForm = () => {
        ...
        <>
            <div className="m-5">
                ...
                <div className="registrationForm">
                    ...
                    <form className="mb-5" action="/newSavingsAccountFixedDeposit" method="post">
                    ...
                    <input type="hidden" name="fixedDepositStartDate" value={new Date()}></input>
                    ...
                    {/* Now Inputs That will show on Page */}
                        ...
                        <div className="mb-3"> <label for="exampleFormControlInput1" className="form-label"> Fixed Deposit Amount (in Rupees Only) *</label>
                            <input autoComplete="off" onChange={handleInput} type="number" className="form-control" id="exampleFormControlInput1" name="fixedDepositAmount" placeholder="" />
                        </div>

                        <div className="mb-3"> <label for="exampleFormControlInput1" className="form-label"> Total Time Of Fixed Deposit (In Years And also without any Decimal) *</label>
                            <input autoComplete="off" onChange={handleInput} type="number" className="form-control" id="exampleFormControlInput1" name="fixedDepositTotalTimeInYears" placeholder="" />
                        </div>
...
export default CurrentAccountNewFixedDepositForm;
