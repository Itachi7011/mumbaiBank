...
const SavingAccounFixedDeposit = () => {
                            ...
                            return (<div className="card-body jobSearchCard-body" key={email}>
                                ...
                                <div className="mb-5" style={{
                                    ...
                                    <button className="btn btn-primary btn-lg" onClick={() => {
                                        navigate("/ViewSavingAccountOngoingFixedDeposit",
                                            {
                                                state: {
                                                    id: _id,
                                                    name: name,
                                ...
                                <div className="mb-5" style={{
                                    ...
                                    <button type="submit" className="btn btn-primary btn-lg" onClick={() => {
                                        navigate("/SavingAccountNewFixedDepositForm",
                                            {
                                                state: {
                                                    id: _id,
                                                    name: name,
...
export default SavingAccounFixedDeposit;
