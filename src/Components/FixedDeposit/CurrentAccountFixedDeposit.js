...
const CurrrentAccountFixedDeposit = () => {
    ...
    const Requests = () => {
        ...
        if (Profile) {
            if (user.searchinput === "") {
                return (<div className="main-body"><h2>Please Enter Input</h2></div>)
                            ...
                            return (<div className="card-body jobSearchCard-body" key={email}>
                                ...
                                <div className="mb-5" style={{
                                    ...
                                    <button className="btn btn-primary btn-lg" onClick={() => {
                                        navigate("/ViewCurrentAccountOngoingFixedDeposit",
                                            {
                                                state: {
                                                    id: _id,
                                                    name: name,
                                        ...
                                        View All Fixed Deposits </button>
                                ...
                                <div className="mb-5" style={{
                                    ...
                                    <button type="submit" className="btn btn-primary btn-lg" onClick={() => {
                                        navigate("/CurrentAccountNewFixedDepositForm",
                                            {
                                                state: {
                                                    id: _id,
                                                    name: name,
                                        ...
                                        Create New Fixed Depost </button>
...
export default CurrrentAccountFixedDeposit;