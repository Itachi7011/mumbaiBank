          ...
          <div className="">
            <div>
              <h2 className="name-profile">
                {user.name} &nbsp; &nbsp; ({user.scale}-Scale)
              </h2>
              <a
                href="/EditEmpProfiles"
                style={{
              ...
              <div className="profile-data">
                <span className="left-span">Bank-Name : </span>
                <span className="right-span">{user.bankName}</span>
              </div>
              <div className="profile-data">
                <span className="left-span">Branch : </span>
                <span className="right-span">{user.bankBranch}</span>
              </div>
              <div className="profile-data">
                <span className="left-span">Designation (POST) : </span>
                <span className="right-span">{user.postDuringJoining}</span>
              </div>
              <div className="profile-data">
                <span className="left-span">Bank-Name : </span>
                <span className="right-span">{user.bankName}</span>
                            ...
                            <div className="col-md-7 ps-md-4">
                                ...
                                <div className="btn btn-primary me-2" style={{ marginBottom: "2rem" }}><a href="/EditEmpProfiles" style={{border:"4px solid black", textAlign: "none", backgroundColor:"red", color: "white", padding: "1rem", fontWeight: "bold", fontSize:"larger" , marginBottom: "2rem"}}>Edit Profile</a></div>
                                        ...
                                        <div className="d-flex align-items-center profile-div-both1  justify-content-between border-bottom">
                                            <p className="py-2"><span className="font-medium profile-content-left">Email - </span></p>
                                            <p className="py-2 text-muted"><span className="font-medium">{user.email}</span></p><br/>
                                        </div>
                                        <div className="d-flex align-items-center profile-div-both1  justify-content-between border-bottom">
                                            <p className="py-2"><span className="font-medium profile-content-left">Age - </span></p>
                                            <p className="py-2 text-muted"><span className="font-medium">{user.age}</span></p><br/>
                                        </div>

                                        <div className="d-flex align-items-center  profile-div-both1 justify-content-between border-bottom">
                                            <p className="py-2"><span className="font-medium profile-content-left">Phone -1 - </span></p>
                                            <p className="py-2 text-muted"><span className="font-medium">{user.phoneNo_1}</span></p><br/>
                                        </div>

                                        <div className="d-flex align-items-center  profile-div-both1 justify-content-between border-bottom">
                                            <p className="py-2"><span className="font-medium profile-content-left" >Phone -2 - </span></p>
                                            <p className="py-2 text-muted"><span className="font-medium">{user.phoneNo_2}</span></p><br/>
                                        </div>

                                        <div className="d-flex align-items-center  profile-div-both1  justify-content-between border-bottom">
                                            <p className="py-2"><span className="font-medium profile-content-left">Country - </span></p>
                                            <p className="py-2 text-muted"><span className="font-medium"> {user.country}</span></p><br/>
                                        </div>
                                        <div className="d-flex align-items-center profile-div-both1  justify-content-between border-bottom">
                                            <p className="py-2"><span className="font-medium profile-content-left" >State - </span></p>
                                            <p className="py-2 text-muted"><span className="font-medium"> {user.state}</span></p><br/>
                                        </div>

                                        <div className="d-flex align-items-center profile-div-both1  justify-content-between border-bottom">
                                            <p className="py-2"><span className="font-medium profile-content-left" >Address - </span></p>
                                            <p className="py-2 text-muted"><span className="font-medium">{user.fullAddress}</span></p><br/>
                                        </div>

                                        
                                        <div className="d-flex align-items-center profile-div-both1  justify-content-between border-bottom">
                                            <p className="py-2"><span className="font-medium profile-content-left" >Work As - </span></p>
                                            <p className="py-2 text-muted"><span className="font-medium">{user.postDuringJoining}</span></p><br/>
                                        </div>
                                        <div className="d-flex align-items-center profile-div-both1  justify-content-between border-bottom">
                                            <p className="py-2"><span className="font-medium profile-content-left">Qualifications - </span></p>
...
export default Scale1EmpProfile;
