        ...
        <div className="main-body1">
            ...
            <div className="registrationForm">
                ...
                <form action="/reqNewCurrAcc" method="POST">
                    ...
                    <div className="mb-3"> <label for="exampleFormControlInput1" className="form-label">Company's or Organisation's or Govt. Department's Name *</label>
                        <input autoComplete="off" onChange={handleInput} type="text" className="form-control" id="exampleFormControlInput1" name="companyName" placeholder="" />
                    </div>

                    <div className="mb-3"> <label for="exampleFormControlInput1" className="form-label">Company's or Organisation's Registered GST-IN Number *</label>
                        <input autoComplete="off" onChange={handleInput} type="text" className="form-control" id="exampleFormControlInput1" name="gstNumber" placeholder="" />
                    </div>

                    <div className="mb-3"> <label for="exampleFormControlInput1" className="form-label">Total Annual Turnover of that Company or Organisation (In Rupees Only) *</label>
                        <input autoComplete="off" onChange={handleInput} type="text" className="form-control" id="exampleFormControlInput1" name="companyAnnualTurnover" placeholder="In Rupees Only" />
                    </div>

                    <div className="mb-3">
                        <label for="exampleFormControlInput1" className="form-label">Active Loan/Loans *</label>

                        <select className="form-select form-select-lg mb-3" aria-label=".form-select-lg example" name="activeLoans" onChange={handleInput}>
