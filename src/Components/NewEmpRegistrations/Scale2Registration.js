            ...
            <div className="main-body1">
                ...
                <div className="registrationForm">
                    ...
                    <form action="/scale2EmpRegister" method="POST">
                        ...
                        <input className="formInputRegistraion" type="hidden" name="scale" value="Ist Scale" placeholder="" />

                        {/* Hidden Scale Input Value : */}
                        <input className="formInputRegistraion" type="hidden" name="dateOfFormSubmission" value={Date.now} placeholder="" />
