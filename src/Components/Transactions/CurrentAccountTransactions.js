...
const SavingAccountTransactions = () => {
            ...
            if (user.searchinput === "") {
...

                {
                    Data.post.filter((data) => {
                        ...
                        .map(({ _id, name, email, totalAmount, phoneNo_1, phoneNo_2, accountNumber, fatherName, bankName, bankBranch, accountType, accountStatus,companyName, gstNumber, companyAnnualTurnover }) => {
                            return (<div className="card-body jobSearchCard-body" key={_id} style={{ padding: "2rem 0rem", border: "1rem solid black", marginBottom: "1rem" }}>
                                ...
                                <div className="card-body jobSearchCard-body">
                                    <h5 className="mb-3 card-title centercard"><span className="cardspan">Current Amount</span> : <span style={{ color: "yellow", fontWeight: "bolder" }}>{totalAmount}</span></h5>
                                </div>
                                ...
                                <div className="mb-5" style={{
                                    ...
                                    <button className="btn btn-primary btn-lg" onClick={() => {
                                        navigate("/ShowCurrentAccountTransactions",
                                            {
                                                state: {
                                                    id: _id,
                                                    name: name,
...
export default SavingAccountTransactions;