...
const TechnincalStaffRegistration = () => {
    let name, value;
    ...
    return(
        <>
            ...
            <div className="nav-btn">
                <h1> New Employee Registration (Only Technical Staff) : </h1>
            ...
            <form action="/technicalStaffRegister" method="POST">
                ...
                <div className="mb-3"> <label for="exampleFormControlInput1" className="form-label">Name *</label>
                 ...
                 <input autoComplete="off" onChange={handleInput} type="date" className="form-control" id="exampleFormControlInput1" name="dateOfBirth" placeholder=""/>
                  ...
                  <div className="mb-3"> <label for="exampleFormControlInput1" className="form-label">Age *</label>
                 <input autoComplete="off" onChange={handleInput} type="number" className="form-control" id="exampleFormControlInput1" name="age" placeholder=""/>
                  </div>


                  <div className="mb-3"> <label for="exampleFormControlInput1" className="form-label">Company's or Agency's Name *</label>
                ...
                <div className="mb-3">
                 <label for="exampleFormControlInput1" className="form-label">POST during joining *</label>
                   ...
                   <option value="3">Loan Department</option>
                   <option value="3">Fixed Deposit Department</option>
                   <option value="3">Miscelleneous</option>
                    </select>
                 ...
                 <input autoComplete="off" onChange={handleInput} type="password" className="form-control" id="exampleFormControlInput1" name="password" placeholder="create a strong , unpredectible password"/>
                  ...
                  {/* <div className="mb-3"> <label for="exampleFormControlInput1" className="form-label">choose File *</label>
...
export default TechnincalStaffRegistration;
