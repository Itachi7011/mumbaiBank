...
const SavingCreditAmount = () => {
                ...
                <div>
                    <div className="main-body">
                        ...
                        <h2>Account Holder's Name is " {previousPageName} " with email id - " {previousPageEmail} ".
                            <br />
                            Please Enter Amount to Credit / Add into {previousPageName} 's Account
                        </h2>
    ...
    return (
        <>
            <Requests />
            <div className="main-body">
                <form action="/confirmSavingAccountCredit" method="post">
                    ...
                    <span></span><input type="number" name="amount" onSubmit={inputHandler}></input>
...
export default SavingCreditAmount;
