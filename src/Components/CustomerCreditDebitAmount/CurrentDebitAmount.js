                ...
                <div>
                    <div className="main-body">
                        ...
                        <h2>Account Holder's Name is " <span className="boldSpan1" ><b><i> {previousPageName} </i></b></span> " with email id - " {previousPageEmail} ".
                            <br /><br />
                            Please Enter Amount to <span className="boldSpan1" ><b><i> Debit / Subtract </i></b></span> into <span className="boldSpan1" ><b><i> {previousPageName} </i></b></span> 's Account
                        </h2>
    ...
    return (
        <>
            ...
            <div className="main-body1">
                ...
                <form action="/confirmCurrentAccountDebit" method="post">
...
export default CurrentDebitAmount;