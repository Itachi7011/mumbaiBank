...
const CustomerSavingCreditDebitAmount = () => {
    ...
    useEffect(() => {
        ...
        axios.get('/savingAccountCreditDebitAmount').then((response) => {
...
<div className="mb-5" style={{
                                    ...
                                    <button className="btn btn-primary btn-lg" onClick={() => {
                                        navigate("/CustomerCurrentCreditDebitAmount")
                                    }} style={{ float: "left" }}>

                                      Click  For Currrent Account Transactions </button>

                                </div>
        <h2 className="searchtext1 main-body main-header" >Saving Account Transactions List : </h2>
...
export default CustomerSavingCreditDebitAmount;
