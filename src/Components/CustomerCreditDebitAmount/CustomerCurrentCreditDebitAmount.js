...
const CustomerCurrentCreditDebitAmount = () => {
            ...
            if (user.searchinput === "") {
...

                {
                    Data.post.filter((data) => {
                        ...
                        .map(({ _id, name, email, totalAmount, phoneNo_1, phoneNo_2, accountNumber, fatherName, bankName, bankBranch, accountType, companyName, gstNumber,accountStatus, }) => {
    ...
    return (<><div className="m-5 searching main-body ">
        <div className="mb-5" style={{
                                    ...
                                    <button className="btn btn-primary btn-lg" onClick={() => {
                                        navigate("/CustomerSavingCreditDebitAmount")
                                    }} style={{ float: "left" }}>

                                      Click  For Saving Account Transactions </button>

                                </div>
        <h2 className="searchtext1 main-body main-header" >Current Account Transactions List : </h2>

        <h2 className="searchtext1 main-body" >Search Account by Account Holder Name / Registered Email : </h2><br/><br/>
        <div className="main-body">

        

            <input type="text" className="searchinput main-body" name="searchinput" autoComplete="off" onChange={inputHandler} placeholder="Please type here" />
        </div>
...
export default CustomerCurrentCreditDebitAmount;