...
const ConfirmNewSavingAccountRequest = () => {
        ...
        return(user.post.map(({ _id, name, email }) => {
            return (<div className="card-body jobSearchCard-body" key={email}>
                ...
                <div className="mb-5" style={{
                    ...
                    <form action="/confirmNewSavingAccountRequest" method="POST">
                ...
                <div className="mb-5" style={{
                    ...
                    <form action="/rejectNewSavingAccountRequest" method="POST">
                        <input type="hidden" value={_id} name="id" ></input>
                        <input type="hidden" value={email} name="email" ></input>
...
export default ConfirmNewSavingAccountRequest;
